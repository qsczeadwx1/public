...
<link href="../design/css/login.custom_c.css?nocache=20230922" rel="stylesheet" type="text/css">
</head>
<body>
...
<div id="loginW">
	...
	<div class="left_img"><img src="../image/login/custom/title_20220906.png"></img></div>
	<div class="right_img"><img src="../image/login/custom/title2_20220906.png"></img></div>
	
	<div id="loginBOXw">
		  <div id="loginBOX">
				<div class="login_top">
					<img src="../image/login/custom/login/ci.group_2023_0921.png?nocache=202301181"  alt="nest">
